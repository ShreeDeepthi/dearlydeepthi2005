...
JLabel l1 = new JLabel("Vaibhavi's fav", JLabel.CENTER);
l1.setForeground(Color.BLUE);
l1.setFont(new Font("Algerian",Font.BOLD,30));
JLabel l2 = new JLabel("Bestfriend:", JLabel.LEFT);
l2.setForeground(Color.BLUE);
l2.setFont(new Font("Algerian",Font.BOLD,10));
JTextField t1 = new JTextField ();
JLabel l3 = new JLabel("Singer:", JLabel.LEFT);
l3.setForeground(Color.BLUE);
l3.setFont(new Font("Algerian",Font.BOLD,10));
JPasswordField p1 = new JPasswordField();
JButton b1 = new JButton("Save vaibhs fav");
JButton b2 = new JButton("Saranghae");
