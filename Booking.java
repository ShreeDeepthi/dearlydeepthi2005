// Movie Ticket Booking System in Java Using Synchronization
class Booking
{
...
Ticket t3=new Ticket(Titanic,57);
Ticket t4=new Ticket(Titanic,57);
Ticket t5=new Ticket(Titanic,56);
Ticket t6=new Ticket(Titanic,56);
t1.setName("Seat1:56");
t2.setName("Seat2:56" );
t3.setName("Available seat:57");
t4.setName("Available seat:123");
